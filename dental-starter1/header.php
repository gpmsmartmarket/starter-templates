        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="h-address">
                        <i class="fa fa-location-arrow"></i> <?php if (function_exists('contact_detail')) { contact_detail('address_short'); } ?> - <a href="#">Get Directions</a>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="h-hours">
                        <?php if (function_exists('contact_detail')) { contact_detail('hours_short'); } ?>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                    ...
                    <?php if (!empty($phone_new)) : ?>
                        <div class="h-phone h-phone-right h-phone-top">
